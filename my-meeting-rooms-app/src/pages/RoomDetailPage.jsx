...
export default function RoomPage() {
  ...
  return (
    <>
      <Header />
      {/* Отступ сверху (mt-24) нужен, чтобы контент не накладывался на фиксированную шапку */}
      <div className="max-w-3xl mx-auto p-6 bg-white rounded shadow mt-24">
        <img
          src={room.image}
          alt={room.name}
        ...
        <div className="flex justify-between">
          ...
          <button
            onClick={() => alert("Бронирование прошло успешно!")}
